...
public class Toolbar {
  ...
  private void setAccessibleDescriptions() {
    openButton.getAccessibleContext().setAccessibleDescription("Hello, Open a file");
    closeButton.getAccessibleContext().setAccessibleDescription("Close the current file");
    undoButton.getAccessibleContext().setAccessibleDescription("Undo the last action");
    redoButton.getAccessibleContext().setAccessibleDescription("Redo the last undone action");
    cutButton.getAccessibleContext().setAccessibleDescription("Cut the selected text");
    copyButton.getAccessibleContext().setAccessibleDescription("Copy the selected text");
    pasteButton.getAccessibleContext().setAccessibleDescription("Paste the copied text");
    searchButton.getAccessibleContext().setAccessibleDescription("Search the text");
    compileButton.getAccessibleContext().setAccessibleDescription("Compile the code");
    interruptButton.getAccessibleContext().setAccessibleDescription("Interrupt the current process");
    testButton.getAccessibleContext().setAccessibleDescription("Test the code");
    treeWindowButton.getAccessibleContext().setAccessibleDescription("Toggle the tree window");
    outputWindowButton.getAccessibleContext().setAccessibleDescription("Toggle the output window");
    statusButton.getAccessibleContext().setAccessibleDescription("Show the status of the last compile");
}
